...
public class ReservationService(ReservationServiceContext context,
						   IValidator<AddReservationDto> addValidator) : IReservationService, IDisposable
{
	private readonly ReservationServiceContext _context = context;
	private readonly IValidator<AddReservationDto> _addValidator = addValidator;
